...
public class Collections {
    public static <T, R> Iterable<R> map(Function1<? super T, R> f, Iterable<T> cont) {
    ...
    public static <T> Iterable<T> filter(Predicate<? super T> pred, Iterable<T> cont){
    ...
    public static <T> Iterable<T> takeWhile(Predicate<? super T> pred, Iterable<T> cont) {
        List<T> result = new ArrayList<>();
        for (T e : cont) {
            if (!pred.apply(e)){
                break;
    ...
    public static <T> Iterable<T> takeUnless(Predicate<? super T> pred, Iterable<T> cont) {
